...
<%-- 							code="menu.changeLimitCard" /></a></li> --%>
			...
			<sec:authorize access="hasAuthority('csc_admin_initiator')">
				<li><a href="${contextPath}/homePrepaidCardIndividuel">Recharge MC Prépayée Individuel</a></li>
			</sec:authorize>
			<sec:authorize access="hasAuthority('csc_admin_initiator')">
				<li><a href="${contextPath}/homePrepaidCard">Recharge MC Prépayée en Masse</a></li>
			</sec:authorize>
			
			<sec:authorize access="hasAuthority('csc_admin_initiator')">
				<li><a href="${contextPath}/loadpendingcancelmcInitiator">Historique annulation carte</a></li>
			</sec:authorize>
			
			<sec:authorize access="hasAuthority('csc_admin_administrator')">
				<li><a href="${contextPath}/loadpendingcancelmc">Approbation annulation carte</a></li>
			</sec:authorize>
			...
			<sec:authorize access="hasAuthority('csc_admin_administrator')">
				<li><a href="${pageContext.request.contextPath}/approveCardsMcPrepaidIndividual">Approbation MC prépayée Individuelle</a></li>
			</sec:authorize>
			<sec:authorize access="hasAuthority('csc_admin_administrator')">
				<li><a href="${pageContext.request.contextPath}/approveCardsMcPrepaidBulk">Approbation MC prépayée en Masse</a></li>
			</sec:authorize>
