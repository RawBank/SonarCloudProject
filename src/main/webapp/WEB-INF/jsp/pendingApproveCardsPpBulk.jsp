...
<button id="btnTriggerConfirmBlk" class="viewBtn btn-success btn-sm" data-toggle="modal" data-target="#approveReloadModalPrepaidBulk">
	APPROBATION RECHARGE CARTE PREPAYEE EN MASSE
</button>
<hr>
	...
	<div class=" col-md-12 col-lg-12 mt-2" style="background-color: white">
		<div class="row">
			...
			<div clas="col-md-10 col-lg-10 ">
				<button class="btn btn-primary btn-sm btnReportsApprover " id="psp"
					onclick="getActivitiesAdmPsp('divapprreports','tableapprreports','commentreportsapprreports','getapprouverops')">
